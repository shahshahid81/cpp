...
void find_test()
{
    ...
    // Find will check for provided value which is one.
    ...
    // Find will check for provided value which is Person.
...
void count_if_test()
{
    ...
    // count if value is even
    // Here, we have used lambda, but we can also pass a function by using it's name.
    // e.g.

    // bool isEven(int x) { return x % 2 == 0; }
    // int num = std::count_if(vec.begin(), vec.end(), isEven);
...
void all_of_test()
{
    ...
    // return true if all elements satisfies the predicate
...
void string_transform_test()
{
    ...
    // ::toupper will use the function from global scope
    // 3rd argument is from where the transformation should write data and 4th argument is the function to be used for transformation
