...
void test1()
{
  ...
  // begin() returns the pointer to the first element of the container
  ...
  // end() returns the pointer to the next location after last element of the container
  // should not be dereferenced directly
...
void test3()
{
  ...
  // iterator is constant so values cannot be modified
...
void test4()
{
  ...
  // rbegin() returns the last element of the container
  auto it1 = vec.rbegin(); // reverse iterator over vector of ints starts at 4
  // rend() points to the location before first element
  // should not be dereferenced directly
  while (it1 != vec.rend())
  {
    std::cout << *it1 << std::endl;
  ...
  // returns constant rbegin iterator
