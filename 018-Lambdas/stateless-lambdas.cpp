...
/**
 * Lambda syntax: [] () -> returntype specifiers {}
 * []: capture list. Empty for stateless.
 * (): lambda argument list
 * -> returntype: optional, return type of lambda, can be omitted since compiler can deduce the type
 * specifiers: multable, constexpr etc
 * {}: body of the lambda
 */
