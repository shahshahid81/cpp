...
// Since data is copied, reference count is incremented by one for p
// When p leaves the scope of method, it is decremented by one
...
int main()
{
    ...
    /**
     * Shared pointer points to an object of type T on the heap.
     * Automatically allocates and deallocates the memory.
     * Can be assigned, copied and moved.
     * Uses reference counting and we can get the count by using use_count method.
     * Whenever count is 0, memory is deallocated.
     */
